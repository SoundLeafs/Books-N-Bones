...
public class Enemy : MonoBehaviour
{
    ...
    void Die()
    {
        ...
        //RG Additions
        // Instantiate the floating popup prefab at the enemy's position
        GameObject floatingPopupObj = Instantiate(floatingPopupPrefab, transform.position, Quaternion.identity);

        // Get the FloatingPopup component and initialize it with the moneyGained value
        FloatingPopup floatingPopup = floatingPopupObj.GetComponent<FloatingPopup>();
        floatingPopup.Initialize(moneyGained);
